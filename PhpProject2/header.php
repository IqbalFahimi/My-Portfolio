    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3 class="text-center p-4"><img src="http://localhost/PhpProject2/pic/myprofile.jpg" style="width:auto;height:140px;border-radius:50%;"></h3>
            </div>
        ...
        <div id="head">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="mx-auto">
                <h4 class="text-center">FAHMI's PORTFOLIO</h4>
            </ul>
            </div>
